import { NewExpenditureComponent } from "./admin/accounting/expenditures/new-expenditure/new-expenditure.component";
...
const routes: Routes = [
  ...
  {
    path: "student-course-subject/:id",
    component: StudentCourseSubjectComponent
  },
  {
    path: "lecture-course-subject/:id",
    component: LectureCourseSubjectComponent
  },
  {
    path: "add-subject-for-student/:id",
    component: AddSubjectForStudentComponent
  },
  ...
  {
    path: "lecture-change-password",
    component: LectureChangePasswordComponent
  },
